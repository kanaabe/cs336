...
<h2>Student Registration</h2>
	...
	<form name="form" method="post" action="registerstu.jsp">
	<table>
		...
		<tr><td>Graduation Year:</td><td><input type="text" name="gyear"></td></tr>		
		<tr><td>Major:</td><td><input type="text" name="major"></td></tr>
		<tr><td>GPA:</td><td><input type="text" name="gpa"></td></tr>
		<tr><td>Credits Taken:</td><td><input type="text" name="credits"></td></tr>
